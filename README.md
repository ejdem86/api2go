...
[![Join the chat at https://gitter.im/ejdem86/api2go](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/ejdem86/api2go?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![GoDoc](https://godoc.org/github.com/ejdem86/api2go?status.svg)](https://godoc.org/github.com/ejdem86/api2go)
[![Build Status](https://travis-ci.org/ejdem86/api2go.svg?branch=master)](https://travis-ci.org/ejdem86/api2go)
[![Coverage Status](https://coveralls.io/repos/github/ejdem86/api2go/badge.svg?branch=master)](https://coveralls.io/github/ejdem86/api2go?branch=master)
[![Go Report Card](https://goreportcard.com/badge/ejdem86/api2go)](https://goreportcard.com/report/ejdem86/api2go)
...
```go
go get github.com/ejdem86/api2go
```
...
- Basic Examples can be found [here](https://github.com/ejdem86/api2go/blob/master/examples/crud_example.go).
...
can directly use our sub-package `github.com/ejdem86/api2go/jsonapi` 
...
```go get -tags=gingonic github.com/ejdem86/api2go```
