...
import (
	...
	"github.com/ejdem86/api2go/examples/model"
	"github.com/ejdem86/api2go/examples/resolver"
	"github.com/ejdem86/api2go/examples/resource"
	"github.com/ejdem86/api2go/examples/storage"
)
